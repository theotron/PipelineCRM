...
namespace GrowCreate.PipelineCRM.Umbraco.Installer
{
    public class PackageActions
    {
        public class TransformConfig : IPackageAction
        {
            public string Alias()
            {
                return "GrowCreate.PipelineCRM.TransformConfig";
            }
            ...
            {
                string str = "<Action runat=\"install\" undo=\"true\" alias=\"GrowCreate.PipelineCRM.TransformConfig\" file=\"~/web.config\" xdtfile=\"~/app_plugins/demo/web.config\">" +
                         "</Action>";
